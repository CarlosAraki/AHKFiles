...
substring := SubStr(fullString, startPosition, length) "\ipsdlink.txt"
FileRead, content, %fullString%
...
Loop, % lines0 {
    ...
    Send, ^+i ; Ctrl+Shift+I é o atalho para abrir as DevTools no Chrome e Firefox
    Sleep, 2000
    Send, document.getElementById('ulMenu_354_span').click();
    Send, {Enter}
    Send, document.getElementById('ulMenu_357_a').click();
    Sleep, 200
    Send, {Enter}
    ...
    filePath := "\\Mac\Home\Documents\AutoHotkey\dlink\" fileName
